...
retrieve_student_exams_bp = Blueprint('retrieve_student_exams', __name__)
db = StudentDatabase()


@retrieve_student_exams_bp.route('/student/exams', methods=['GET'])
def retrieve_student_exams():
    try:
        ...
        result = db.retrieve_student_exams(student_id)
